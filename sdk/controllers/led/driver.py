...
class Led :
    ...
    def __init__(self):
        ...
        loaderFilePath = os.path.join(scriptPath,'PiBits','ServoBlaster','user')
        print("sudo %s/servod --p1pins=13,15,16 --step-size=2us --cycle-time=5000us"%loaderFilePath +" --min=0% --max=100%")
